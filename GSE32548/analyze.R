...
qdraw(
  {
    hist(target.probe.expr, breaks=50, main=target, xlab="log expression")
...
fisher.test(table(pheno$group, pheno$"tumor stage:ch1"))
fisher.test(table(pheno$group, pheno$"tumor grade:ch1"))
